...
const getInitialChecklist = (flags: AllFlags): DocumentCategory[] => [
  ...
  },
  {
    ...
    items: [
      { id: 'i-onus', label: 'Certidão de Ônus Reais atualizada', checked: false, tooltip: 'Emitida pelo Registro Geral de Imóveis (RGI), apresenta o histórico completo de propriedade e eventuais gravames (hipotecas, penhoras, usufrutos, indisponibilidades). Resolve o risco de adquirir um imóvel com restrições judiciais, dívidas garantidas ou disputas de titularidade.' },
      { id: 'i-quitacao-fiscal', label: 'Certidão Quitação Fiscal e Enfitêutica', checked: false, tooltip: 'Emitida pela Prefeitura, comprova a quitação do IPTU e da Taxa de Foro/Laudêmio (quando o imóvel é foreiro). Evita que o comprador assuma dívidas tributárias municipais que acompanham o imóvel (obrigação propter rem).' },
      { id: 'i-condominio', label: 'Declaração de Quitação Condominial', checked: false, tooltip: 'Documento assinado pelo síndico (com firma reconhecida) ou emitido pela administradora, atestando a inexistência de débitos condominiais. Resolve o risco de o comprador herdar dívidas de condomínio, que também acompanham o imóvel independentemente do antigo proprietário.' },
      { id: 'i-funesbom', label: 'Certidão da Funesbom', checked: false, tooltip: 'Comprova a quitação da Taxa de Incêndio cobrada pelo Corpo de Bombeiros Militar do Estado do Rio de Janeiro (CBMERJ). Evita a transferência de débitos da Funesbom ao novo proprietário e eventuais inscrições em dívida ativa estadual.' },
      { id: 'i-2distribuidor', label: 'Certidões do 2º Distribuidor', checked: false, tooltip: 'Específicas do RJ, abrangem certidões de Feitos Cíveis, Protestos e Títulos em nome do vendedor. Resolvem o risco de fraude contra credores: revelam ações em andamento e protestos que possam comprometer a venda ou anular o negócio futuramente.' },
      { id: 'i-interdicoes', label: 'Certidões do 1º e 2º Interdições e Tutelas', checked: false, tooltip: 'Comprovam que o vendedor não está sob interdição judicial, curatela ou tutela, ou seja, possui plena capacidade civil para vender. Resolve o risco de nulidade do negócio por incapacidade de uma das partes.' },
