...
// de qualquer estatística. Fonte única: as cópias espalhadas pelos hooks
// (useKPIStats, useEvolutionData, etc.) devem migrar para este módulo e,
// na Fase 2, para a tabela `outlier_limits` no banco.
//
// Os tetos são o superconjunto das tabelas existentes (13 bairros base +
// bairros da Zona Norte/Jacarepaguá). Os pisos vêm de
// useHistoricalTransactionAnalysis, calibrados ~20% abaixo do P5 real de
// cada bairro para não descartar anos inteiros de bairros de ticket menor.
